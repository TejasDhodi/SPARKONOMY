const CreateInvoice = () => {
    return (
        <>
        <div className='flex flex-col items-center gap-2 bg-commonGray w-full lg:w-[400px] mx-auto h-auto rounded-[40px] p-2 cursor-pointer '>
        ...
        <p className='text-primary-purple text-center text-xs my-4 lg:text-xl'>Or Upload an existing invoice and set payment reminder</p>
        </>
    )
}
